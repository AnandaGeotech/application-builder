...
const UserDetailSkeletonLoader = () => (
  <>
    <section className="w-11/12 md:w-4/5 flex flex-col md:flex-row  bg-slate-900  p-4 md:p-8 rounded-xl shadow-lg ">
      <div className="bg-slate-900 w-full   p-4 py-10 md:p-8 ">
