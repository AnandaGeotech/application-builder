          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-1 sm:grid-cols-2">
            <div className="col-span-full  grid grid-cols-1 gap-x-6  sm:grid-cols-6">
              <div className="col-span-3">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.FIRST_NAME} />
              </div>
              <div className="col-span-3">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.LAST_NAME} />
              </div>
            </div>

            <div className="col-span-full  grid grid-cols-1 gap-x-6  sm:grid-cols-6">
              <div className="sm:col-span-3 ">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.PHONE} />
              </div>

              <div className="sm:col-span-3">
                {' '}
                <ABSelect {...ADD_FORM_BUILDER_FORM_FIELDS.GENDER} />
              </div>
            </div>
            <div className="col-span-full  grid grid-cols-1 gap-x-6  sm:grid-cols-6">
              <div className="sm:col-span-3 ">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.HOMETOWN} />
              </div>

              <div className="sm:col-span-3">
                {' '}
                <ABSelect {...ADD_FORM_BUILDER_FORM_FIELDS.LANGUAGE} />
              </div>
            </div>
            <div className="col-span-full  grid grid-cols-1 gap-x-6  sm:grid-cols-6">
              <div className="sm:col-span-3 ">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.BIRTH_DATE} />
              </div>

              <div className="sm:col-span-3">
                {' '}
                <ABSelect {...ADD_FORM_BUILDER_FORM_FIELDS.COUNTRY} />
              </div>
            </div>
            <div className="col-span-full  grid grid-cols-1 gap-x-6  sm:grid-cols-6">
              <div className="sm:col-span-3 ">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.COMPANY} />
              </div>

              <div className="sm:col-span-3">
                {' '}
                <ABSelect {...ADD_FORM_BUILDER_FORM_FIELDS.MARITUAL_STATUS} />
              </div>
            </div>
            <div className="sm:col-span-2">
              <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.PRESENT_ADDRESS} />
            </div>
            <div className="sm:col-span-2">
              <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.PARMANENT_ADDRESS} />
            </div>

            <div className="col-span-full border-b border-gray-900/10 grid grid-cols-1 gap-x-6  sm:grid-cols-6">
              <div className="sm:col-span-2 sm:col-start-1">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.CITY} />
              </div>

              <div className="sm:col-span-2">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.STATE} />
              </div>

              <div className="sm:col-span-2">
                <ABInput {...ADD_FORM_BUILDER_FORM_FIELDS.PINCODE} />
              </div>
            </div>
