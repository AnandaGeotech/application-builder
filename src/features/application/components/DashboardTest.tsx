  ...
  return (
    <div>
      ...
      <aside
        ...
        className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform md:translate-x-0 -translate-x-full  bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
      ...
      <aside
        ...
        } bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 md:-translate-x-full`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
