  ...
  return (
    <div className="flex flex-col space-y-8 min-h-screen items-center justify-center bg-slate-950">
      ...
      <div className="w-[95%] sm:w-full max-w-md p-6 bg-inherit rounded-2xl border-4 border-slate-900">
        <h2 className="text-2xl mb-4 text-gray-500 text-center font-bold">Login</h2>

        <form onSubmit={handleSubmit} ref={formRef} className="space-y-4">
          {/* Email Field */}
          <div>
            <label
              className="block text-md font-medium text-gray-400 mb-2 flex items-center gap-2"
              aria-label="email"
              htmlFor="email"
            >
          ...
          {/* Login Button */}
          <Button type="submit" variant="Login" size="lg" style={{ marginTop: '50px' }}>
            Sign in
          </Button>
        </form>
