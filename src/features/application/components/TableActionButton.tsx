    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          className={`min-w-[120px] flex items-center flex-col rounded-md bg-white dark:text-black
             shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform] data-[side=bottom]:animate-slideUpAndFade
        ...
        >
          <DropdownMenu.Item
            ...
            className={`cursor-pointer group relative flex h-[25px] select-none items-center rounded-[3px] text-[13px] leading-none text-violet11
